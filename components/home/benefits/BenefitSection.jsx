                ...
                <ul className={styles.list}>
                    <li className={styles["list-item"]}>
                        <article>
                            ...
                            <p>
                                Få bilen din til å få tilbake sin opprinnelige
                                rike fargen uten polering og lakkfjerning
                            </p>
                        </article>
                    </li>
                    <li className={styles["list-item"]}>
                        <article>
                            ...
                            <p>
                                Har du lyst til å få bilen til å stråle igjen
                                som den gjorde da den var ny?
                            </p>
                        </article>
                    </li>
                    <li className={styles["list-item"]}>
