        ...
        <section className={`${styles.section} section`} id="omoss">
            ...
            <div className="container">
                ...
                <p className={styles.text}>
                    ...
                    lakkbeskyttelse, og lakkgjennoppretting har opparbeidet seg
                    lang erfaring av å jobbe med ulike merker og typer kjøretøy.
                    <br></br>
                    <br></br>Ved å bruke ledende teknologier på markedet innen
                    bilpleie, leverer vi det bilen din aller mest trenger. Vi
                    jobber både med gamle og nye biler.
                </p>
            </div>
        </section>
    );
