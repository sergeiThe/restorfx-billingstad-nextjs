                    ...
                    <div className={styles.card}>
                        ...
                        <div className={styles.content}>
                            ...
                            <p className={styles.p}>
                                Supervannavvisende lakkforsegling for bil.
                                <br></br> RestorFX var banebrytende med
                                lanseringen av den mest avanserte teknologien
                                for lakkgjenoppretting og lakkreparasjon på
                                markedet. Teknologien vil gjenopprette
                                overflaten på et kjøretøy slik at den ser ut som
                                en helt ny bil, rett fra fabrikken.
                            </p>
                    ...
                    <div className={styles.card}>
                        ...
                        <div className={styles.content}>
                            ...
                            <p className={styles.p}>
                                ...
                                utseendemessige problemer med bilen vil
                                forsvinne. Behandlingen skjer i tre steg.
                            </p>
                            <ul>
